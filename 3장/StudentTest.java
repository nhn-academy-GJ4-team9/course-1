...
class StudentTest {
    ...
    void  getStudentConstructionTestWithError() {
        Assertions.assertThrows(NullPointerException.class, () -> new Student(null, "1", "CS"));
        Assertions.assertThrows(NullPointerException.class, () -> new Student("NAME", null, "CS"));
        Assertions.assertThrows(NullPointerException.class, () -> new Student("NAME", "1", null));
    }
