...
public class problem04 {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < TEST_CASES.length; i++) {
            System.out.println("Test Case " + (i + 1) + " = " + test(TEST_CASES[i],TEST_CASES2[i],TEST_CASES3[i], TEST_CASES_RESULT[i]));
        }
    ...
    //my 에서 인덱스 2부터 overwrite의 길이만큼에 해당하는 부분은 "11oWord1" 이고 이를 "lloWorl"로 바꾼 "HelloWorld"를 return 
