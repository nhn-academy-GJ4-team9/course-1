...
public class Main {
    ...
    public static void solution(int number) {
        ...
        if (number == 0)
            ...
            System.out.println("Activation (" + (number) + ")");
            System.out.println("Activation (" + (number - 1) + ")");
            preCondition(number);
            System.out.println("Finished (" + (number -2) + ")");
            System.out.println("Re - activatioed (" + (number - 1) + ")");
            System.out.println("Finished (" + (number -1) + ")");
            System.out.println("Re - activatioed (" + (number) + ")");
